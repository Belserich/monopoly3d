...
public class Global {
    ...
    public static long randomSeed = 3;                  // setzt den RandomSeed für kurze und originale Version; 0 = zufall
    public static boolean START_COMPLETED = true;       // startet mit vollem Straßenzug
