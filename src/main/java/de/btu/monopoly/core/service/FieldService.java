...
public class FieldService {
     ...
     * sondern für das {@code i}-te PropertyField Feld. Die Aufzählung beginnt
    ...
    /**
     * Hilfsmethode (siehe
     * {@code getRent(PropertyField prop, int[] rollResult, int amplifier)})
     */
