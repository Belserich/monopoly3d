...
public class FieldService {
     ...
     * PropertyField. Die Aufzählung beginnt bei der Ersten Straße und schreitet dann im Uhrzeigersinn fort.
     */
    ...
    /**
     * Setzt die Spielerposition auf die des Gefängnisfelds und führt {@link PlayerService#toJail(Player)} aus.
     *
    ...
    /**
     * Berechnet den wahren Mietswert eines Grundstücks unter Berücksichtigung des Würfelergebnisses und eines Multiplikators (für
     * bestimmte Karten).
     *
    ...
    /**
     * Zieht dem Konto des Spielers Geld in Höhe des Mietswertes des angegebenen PropertyField-Felds ab und gibt das Geld an den
     * Besitzer des Feldes weiter.
     *
     * @param player Spieler
     * @param prop Feld
